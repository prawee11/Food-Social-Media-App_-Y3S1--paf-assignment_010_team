...
const CreatePost = ({ currentUser, refetchPosts }) => {
  ...
  return (
    <>
      <div className="editor mx-auto w-10/12 flex flex-col text-gray-800 border rounded-lg border-gray-100 p-4 shadow-lg max-w-2xl postbg">
        <textarea
          onChange={handleDescription}
          value={post.description}
          className="description bg-gray-100 rounded-lg sec p-3 h-50 border border-gray-300 outline-none"
          spellCheck="false"
        ...
        <div className="icons flex text-gray-500 m-2">
          <label htmlFor="attachments">
            <div
              type="button"
              className="inline-flex justify-center p-2 text-gray-500 rounded-lg cursor-pointer hover:text-gray-200 hover:bg-gray-100 dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-200"
            >
              <svg
                aria-hidden="true"
                className="w-6 h-6"
          ...
          <div className="count ml-auto">
            <div className="buttons flex">
              <div
                onClick={submitPost}
                className="btn border border-indigo-500 p-1 px-4 font-semibold cursor-pointer text-gray-200 bg-blue-900 ml-auto"
              >
                Post
              </div>
            </div>
